...
const config = {
  generator: {
    ...
    previewFeatures: [],
    sourceFilePath:
      "/Users/ericledonge/Perso/grouped-order/prisma/schema.prisma",
    isCustomOutput: true,
  },
  relativeEnvPaths: {
    rootEnvPath: null,
  ...
  inlineSchemaHash:
    "2131e16339be500c6ab2b0e8bde1d7b9ca41462b9ebdda41cef2f412cc2fc18c",
  copyEngine: true,
};
...
path.join(
  process.cwd(),
  "src/lib/generated/prisma/libquery_engine-darwin-arm64.dylib.node",
);
// file annotations for bundling tools to include these files
