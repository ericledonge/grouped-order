...
var en = () => {
    var e, n;
    return (
      ((n = (e = globalThis.process) == null ? void 0 : e.release) == null
        ? void 0
        : n.name) === "node"
    );
  },
  nn = () => {
    ...
    return (
      !!globalThis.Bun ||
      !!(
        (n = (e = globalThis.process) == null ? void 0 : e.versions) != null &&
        n.bun
      )
    );
  },
...
h.comparedTo = h.cmp = function (e) {
  ...
  if (c !== f) return c;
  if (this.e !== e.e) return (this.e > e.e) ^ (c < 0) ? 1 : -1;
...
h.cubeRoot = h.cbrt = function () {
  ...
  for (
    ...
    if (
      ...
      (c = u.times(u).times(u)),
      (f = c.plus(this)),
      (t = k(f.plus(this).times(u), f.plus(c), o + 2, 1)),
...
h.dividedToIntegerBy = h.divToInt = function (e) {
  ...
  return p(k(this, new i(e), 0, 1, 1), i.precision, i.rounding);
};
  ...
  return this.isFinite()
    ? this.isZero()
      ...
      : ((e = t.precision),
        ...
        (t.precision = e + 7),
        (t.rounding = 1),
        k(this.sinh(), this.cosh(), (t.precision = e), (t.rounding = n)))
    : new t(this.s);
};
    ...
    ? r.e >= 0
      ...
      : ((e = s.precision),
        ...
        Math.max(t, e) < 2 * -r.e - 1
          ? p(new s(r), e, n, !0)
          : ((s.precision = i = t - r.e),
            (r = k(r.plus(1), new s(1).minus(r), i + e, 1)),
            (s.precision = e + 4),
            (s.rounding = 1),
            (r = r.ln()),
            (s.precision = e),
...
h.inverseSine = h.asin = function () {
  ...
  return r.isZero()
    ...
    : ((n = r.abs().cmp(1)),
      ...
      n !== -1
        ? n === 0
          ? ((e = F(s, i + 4, t).times(0.5)), (e.s = r.s), e)
          : new s(NaN)
        : ((s.precision = i + 6),
          (s.rounding = 1),
...
h.inverseTangent = h.atan = function () {
  ...
  for (
    w = !1, n = Math.ceil(u / m), t = 1, c = f.times(f), o = new l(f), r = f;
    e !== -1;
  )
    if (
      ((r = r.times(c)),
  ...
  return (
    i && (o = o.times(2 << (i - 1))),
    (w = !0),
    p(o, (l.precision = a), (l.rounding = d), !0)
  );
};
h.isFinite = function () {
  return !!this.d;
...
h.logarithm = h.log = function (e) {
  ...
  if (((i = this.d), this.s < 0 || !i || !i[0] || this.eq(1)))
    return new l(i && !i[0] ? -1 / 0 : this.s != 1 ? NaN : i ? 0 : 1 / 0);
  if (n)
    if (i.length > 1) s = !0;
    else {
...
h.minus = h.sub = function (e) {
  ...
  if (((e = new v(e)), !this.d || !e.d))
    return (
      !this.s || !e.s
        ...
        : this.d
          ? (e.s = -e.s)
          : (e = new v(e.d || this.s !== e.s ? this : NaN)),
      e
    );
  ...
  if (
    ((i = R(e.e / m)), (l = R(this.e / m)), (f = f.slice()), (s = l - i), s)
  ) {
    for (
      a = s < 0,
        a
  ...
  return (
    ...
    !this.d || !e.s || (e.d && !e.d[0])
      ...
      : !e.d || (this.d && !this.d[0])
        ...
        : ((w = !1),
          t.modulo == 9
            ? ((n = k(this, e.abs(), 0, 3, 1)), (n.s *= e.s))
            : (n = k(this, e, 0, t.modulo, 1)),
          (n = n.times(e)),
          (w = !0),
          this.minus(n))
  );
...
h.plus = h.add = function (e) {
  ...
  if (
    ...
    return l[0] || (e = new d(this)), w ? p(e, u, c) : e;
  if (
...
h.precision = h.sd = function (e) {
  ...
  return (
    this.d
      ? ((n = $e(this.d)), e && this.e + 1 > n && (n = this.e + 1))
      : (n = NaN),
    n
  );
};
...
h.squareRoot = h.sqrt = function () {
  var e,
    ...
    l = this.constructor;
  if (f !== 1 || !u || !u[0])
    return new l(!f || (f < 0 && (!u || u[0])) ? NaN : u ? this : 1 / 0);
  for (
    w = !1,
      f = Math.sqrt(+this),
      f == 0 || f == 1 / 0
    ...
    if (
      ((s = t),
      (t = s.plus(k(this, s, i + 2, 1)).times(0.5)),
      b(s.d).slice(0, i) === (n = b(t.d)).slice(0, i))
    )
      if (((n = n.slice(i - 3, i + 1)), n == "9999" || (!r && n == "4999"))) {
        if (!r && (p(s, c + 1, 0), s.times(s).eq(this))) {
          t = s;
          break;
        }
        (i += 4), (r = 1);
  ...
  return i.isFinite()
    ? i.isZero()
      ...
      : ((e = t.precision),
        ...
        (i = i.sin()),
        (i.s = 1),
        (i = k(i, new t(1).minus(i.times(i)).sqrt(), e + 10, 0)),
        (t.precision = e),
        (t.rounding = n),
...
h.toFraction = function (e) {
  ...
  for (
    ...
    (a = k(u, n, 0, 1, 1)), (r = i.plus(a.times(t))), r.cmp(e) != 1;
  )
    (i = t),
      (t = r),
      (r = f),
  ...
  return (
    ...
    (d =
      k(f, t, s, 1)
        .minus(this)
        .abs()
        .cmp(k(c, i, s, 1).minus(this).abs()) < 1
        ? [f, t]
        : [c, i]),
    (N.precision = l),
    (w = !0),
...
h.toNearest = function (e, n) {
  ...
  return (
    e.d[0]
      ? ((w = !1), (i = k(i, e, 0, n, 1).times(e)), (w = !0), p(i))
      : ((e.s = i.s), (i = e)),
    i
  );
};
...
h.toPower = h.pow = function (e) {
  ...
  if (((o = u.s), o < 0)) {
    ...
    if (
      ((e.d[n] & 1) == 0 && (o = 1), u.e == 0 && u.d[0] == 1 && u.d.length == 1)
    )
      return (u.s = o), u;
  }
  return (
    ...
    (n =
      i == 0 || !isFinite(i)
        ? R(f * (Math.log("0." + b(u.d)) / Math.LN10 + u.e + 1))
        : new c(i + "").e),
...
h.toPrecision = function (e, n) {
  ...
  return (
    e === void 0
      ? (i = L(t, t.e <= r.toExpNeg || t.e >= r.toExpPos))
      : (q(e, 1, H),
        n === void 0 ? (n = r.rounding) : q(n, 0, 8),
        (t = p(new r(t), e, n)),
        (i = L(t, e <= t.e || t.e <= r.toExpNeg, e))),
    t.isNeg() && !t.isZero() ? "-" + i : i
  );
};
h.toSignificantDigits = h.toSD = function (e, n) {
  ...
  return (
    e === void 0
      ...
      : (q(e, 1, H), n === void 0 ? (n = t.rounding) : q(n, 0, 8)),
    p(new t(this), e, n)
  );
};
h.toString = function () {
  var n = this.constructor,
    i = L(this, this.e <= n.toExpNeg || this.e >= n.toExpPos);
            ...
            f < 0
              ? ((x = E[0]),
                ...
                f == -1 &&
                  ((P = E.length),
                  (f = n(S, E, T, P)),
                  f < 1 && (d++, i(E, T < P ? y : S, P, c))),
                (P = E.length))
              : f === 0 && (d++, (E = [0])),
            (_[a++] = d),
            f && E[0] ? (E[P++] = O[z] || 0) : ((E = [O[z]]), (P = 1));
  ...
  e: if (n != null) {
    ...
    if (
      (s == 0
        ...
        : ((a.length = d + 1),
          (u = C(10, m - s)),
          (a[d] = o > 0 ? (((l / C(10, r - o)) % C(10, o)) | 0) * u : 0)),
      f)
    )
      for (;;)
        if (d == 0) {
...
function be(e, n) {
  ...
  for (
    ...
    if (
      ...
      (i = i.times(++l)),
      (u = o.plus(k(s, i, c, 1))),
      b(u.d).slice(0, c) === b(o.d).slice(0, c))
    ) {
...
function B(e, n) {
  ...
  for (
    a = N,
      c = o = N = k(N.minus(1), N.plus(1), l, 1),
      d = p(N.times(N), l, 1),
      r = 3;
    ;
  ) {
    if (
      ((o = p(o.times(d), l, 1)),
      (f = c.plus(k(o, new M(r), l, 1))),
      b(f.d).slice(0, l) === b(c.d).slice(0, l))
    )
      if (
        ((c = c.times(2)),
        ...
        if (Q(c.d, l - v, _, u))
          (M.precision = l += v),
            (f = o = N = k(a.minus(1), a.plus(1), l, 1)),
            (d = p(N.times(N), l, 1)),
            (r = u = 1);
...
function gn(e, n) {
  ...
  for (
    s = n.search(/p/i),
      s > 0
        ? ((c = +n.slice(s + 1)), (n = n.substring(2, s)))
        : (n = n.slice(2)),
      s = n.indexOf("."),
      o = s >= 0,
      t = e.constructor,
  ...
  return s < 0
    ...
    : ((e.e = ce(f, l)),
      ...
      (w = !1),
      o && (e = k(e, r, u * 4)),
      c && (e = e.times(Math.abs(c) < 54 ? C(2, c) : Y.pow(2, c))),
      (w = !0),
      e);
}
function mn(e, n) {
...
function j(e, n, i, t, r) {
  ...
  for (w = !1, c = i.times(i), u = new e(t); ; ) {
    if (
      ((o = k(u.times(c), new e(n++ * n++), l, 1)),
      (u = r ? t.plus(o) : t.minus(o)),
      (t = k(o.times(c), new e(n++ * n++), l, 1)),
      (o = u.plus(t)),
      o.d[a] !== void 0)
    ) {
...
function Pe(e, n, i, t) {
  ...
  if (
    (v
      ? (q(i, 1, H), t === void 0 ? (t = g.rounding) : q(t, 0, 8))
  ...
  function r(s) {
    ...
    if (c === "string")
      return (
        ...
        Be.test(s) ? re(this, s) : gn(this, s)
      );
    if (c === "bigint")
      return (
        s < 0 ? ((s = -s), (this.s = -1)) : (this.s = 1), re(this, s.toString())
      );
    throw Error($ + s);
  }
  if (
    ...
    for (
      ...
      Object.hasOwn(e, (i = t[n++])) || (e[i] = this[i]);
  return r.config(e), r;
}
function Tn(e, n) {
...
function Gn(e) {
  var n,
    ...
    u = [];
  if (
    (e === void 0 ? (e = this.precision) : q(e, 1, H),
    (t = Math.ceil(e / m)),
    this.crypto)
  )
